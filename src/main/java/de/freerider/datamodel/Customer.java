...
public class Customer {
	 ...
	 * 
	 * @param id set id once if id is valid {@code >= 0} and id attribute is still
	 *           unassigned {@code < 0}.
	...
	public String getName() {
		return this.lastName + (this.firstName.length() > 0 ? ", " + this.firstName : "");
	}
	 ...
	 * lastName parts and assigns parts to corresponding first- and lastName
	 * attributes.
	 * 
	...
	/**
	 * Name setter for first- and lastName attributes, which are only changed when
	 * arguments are not null or not empty "".
	 * 
	...
	/**
	 * Add new contact. Only valid contacts (not null or "") are stored. Duplicate
	...
	/**
	 * Split single-String name into first- and last name. Examples:
	 * 
	 * <pre>
	 * {@code
